...
|  [isAttackedBy(targetSquare, attackerSquare)](./chess.ts.chess.isattackedby.md) |  | Checks if a square can be attacked by a piece given the current turn. |
|  [isPromotion(move)](./chess.ts.chess.ispromotion.md) |  | Checks if a move results in a promotion. |
|  [isThreatenedBy(targetSquare, attackerSquare)](./chess.ts.chess.isthreatenedby.md) |  | Checks if a square is threatened by a piece given the current position. |
