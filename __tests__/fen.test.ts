...
describe('validateFen', () => {
  describe('position-only', () => {
    const positions: { fen: string; errorType?: FenErrorType }[] = [
      {
      ...
      },
      {
        ...
        errorType: 'ROWS_LENGTH',
      },
      {
        fen: 'rnbqkbnr/pppppppp/17/8/8/8/PPPPPPPP/RNBQKBNR',
        errorType: 'CONSECUTIVE',
      },
      {
        fen: 'rnbqk?nr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR',
        errorType: 'INVALID_PIECE',
      },
      {
        fen: 'rnbqkbnr/pppppppp/7/8/8/8/PPPPPPPP/RNBQKBNR',
        errorType: 'ROW_TOO_LARGE',
      },
      {
        fen: 'rnbqkbnr/p1p1p1p1p/8/8/8/8/PPPPPPPP/RNBQKBNR',
        errorType: 'ROW_TOO_LARGE',
      },
      {
